...
import "./Signin.css";
import { useSetToken, useSetUserId } from "../Auth";
import { useState } from "react";
import Historysend from "../../status/Historysend";
const SignIn = () => {
            ...
            >
              <Form.Item
                ...
                rules={[
                  ...
                  { type: "text", message: "Please enter a valid user email address" },
                  {
                    min: 5,
